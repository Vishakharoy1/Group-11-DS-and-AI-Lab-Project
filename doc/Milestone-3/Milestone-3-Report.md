...
### 6.3 Model Visualization Gallery

The following figures are sourced from `doc/Milestone-3/images/` and the project-level `images/` folder. Together they provide the visual evidence supporting Sections 1–5 of this report.

#### 6.3.1 Raunak — MobileNetV3-Large (Primary / Selected Model)

<div align="center">

![MobileNetV3-Large Architecture](./images/raunak_mobilenetv3_architecture.png)

*Figure 6.2 — MobileNetV3-Large model architecture.*

![MobileNetV3 Dataset Split](./images/raunak_mobilenetv3_dataset_split.png)

*Figure 6.3 — Candidate dataset split for MobileNetV3-Large (24,001 images).*

![MobileNetV3 Training Curves](./images/raunak_mobilenetv3_training_curves.png)

*Figure 6.4 — Training and validation metrics across staged fine-tuning epochs.*

![MobileNetV3 Confusion Matrix](./images/raunak_mobilenetv3_confusion_matrix.png)

*Figure 6.5 — Test-set confusion matrix (2,401 samples; 99.96% accuracy).*

![MobileNetV3 Architecture — Project Images Folder](../../images/mobilenetv3_architecture.png)

*Figure 6.6 — MobileNetV3-Large architecture diagram (project `images/` folder).*

![MobileNetV3 Training Curves — Project Images Folder](../../images/mobilenetv3_training_curves.png)

*Figure 6.7 — MobileNetV3-Large training curves (project `images/` folder).*

</div>

#### 6.3.2 Rohit — Dual-Stream Spatial-Frequency Fusion (Secondary Model)

<div align="center">

![Dual-Stream Detector Architecture](./images/rohit_deepfake_detector_architecture.png)

*Figure 6.8 — Dual-Stream Spatial-Frequency Fusion Network architecture.*

![Spatial vs Frequency FFT Analysis](./images/rohit_spatial_vs_frequency_fft.png)

*Figure 6.9 — Spatial RGB input vs. FFT log-magnitude spectrum with 15% HPF mask.*

![Dataset Distribution Chart](./images/rohit_dataset_distribution_chart.png)

*Figure 6.10 — Full-scale 13-generator dataset composition (637,900 images).*

![Dual-Stream Training Metrics](./images/rohit_training_metrics_curves.png)

*Figure 6.11 — Validation-accuracy progression across Stages 1–3 of hyperparameter tuning.*

</div>

#### 6.3.3 Vishakha — EfficientNet-B2 (Tertiary / Explainability Model)

<div align="center">

![EfficientNet-B2 Architecture](./images/vishakha_efficientnetb2_architecture.png)

*Figure 6.12 — EfficientNet-B2 video-frame classifier architecture with Grad-CAM branch.*

![EfficientNet-B2 Dataset Split](./images/vishakha_dataset_split_chart.png)

*Figure 6.13 — Candidate dataset split (9,996 frames from 8,529 videos).*

![EfficientNet-B2 Training Curves](./images/vishakha_efficientnetb2_training_curves.png)

*Figure 6.14 — Training and validation metrics across Stage 1 and Stage 2 fine-tuning.*

![Grad-CAM Explainability Heatmap](./images/vishakha_gradcam_explainability.png)

*Figure 6.15 — Grad-CAM heatmap overlay highlighting facial regions driving the fake-probability score.*

![Grad-CAM — Project Images Folder](../../images/grad%20cam.png)

*Figure 6.16 — Grad-CAM explainability visualization (project `images/` folder).*
